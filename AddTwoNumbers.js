 ...
 */
 const ListNode = (val, next) => { 
     return {"val": val === undefined ? 0 : val, // value of the current node 
             "next": next === undefined ? null : next} // reference to the next node
}
...
console.log("list1 + list2 = sumList = " + strLinkedList(addTwoNumbers(list1, list2)));